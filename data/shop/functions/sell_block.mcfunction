execute if score @p luna_coin matches 16.. run function shop:sell_block_helper
...
execute if score @p luna_coin matches 16.. run scoreboard players remove @p luna_coin 8
